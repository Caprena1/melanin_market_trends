...
3. Made 4 matplotlib visualizations to display my data and tell a story:
      ...
      D. BOX PLOT - This visualization highlights whether there are significant differences in the price range or median price between Black-owned and Non-Black-owned products. Added image inside plot.
